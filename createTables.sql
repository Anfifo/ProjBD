...
create table Supermercado.produto(
	...
	constraint fk_categoria foreign key (categoria) references Supermercado.categoria(nome),
	constraint fk_forn_primario foreign key (forn_primario) references Supermercado.fornecedor(nif)
);
...
create table Supermercado.prateleira(
	...
	constraint fk_nro foreign key (nro) references Supermercado.corredor
);
...
create table Supermercado.planograma(
	...
	constraint fk_ean foreign key(ean) references Supermercado.produto,
	constraint fk_nro_lado_altura foreign key(nro, lado, altura) references Supermercado.prateleira
);
...
create table Supermercado.categoria_simples(
	...
	constraint fk_nome foreign key (nome) references Supermercado.categoria
);
...
create table Supermercado.constituida(
	...
	categoria Supermercado.CAT_NOME not null,
	constraint fk_super_categoria foreign key (super_categoria) references Supermercado.super_categoria(nome),
	constraint fk_categoria foreign key (categoria) references Supermercado.categoria(nome),
...
create table Supermercado.fornece_sec(
	...
	constraint fk_ean foreign key (ean) references Supermercado.produto,
	constraint fk_nif foreign key (nif) references Supermercado.fornecedor
);
...
create table Supermercado.reposicao(
	...
	constraint fk_ean_nro_lado_altura foreign key (ean, nro, lado, altura) references Supermercado.planograma,
	constraint fk_operador_instante foreign key (operador, instante) references Supermercado.evento_reposicao
);
